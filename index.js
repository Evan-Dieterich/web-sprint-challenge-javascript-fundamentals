...
/* nestedFunction() can access the var internal because nestedFunction() is within the scope of myFunction() where
the var is first defined. */
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    let arr = [];
    zooAnimals.forEach(i => {arr.push(`name: ${i.animal_name}, scientific: ${i.scientific_name}`)});
    return arr;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    return zooAnimals.map(i => i.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    return zooAnimals.filter(i => i.population < 5);
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    return zooAnimals.reduce((acc, i) => acc + i.population, 0);
  }
